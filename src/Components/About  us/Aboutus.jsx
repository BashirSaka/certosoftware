    ...
    return (
      <>
        <section className="bg-white py-12 flex flex-col px-2 min-[769px]:px-24 min-[769px]:py-16 min-[769px]:flex-row justify-between gap-4 min-[769px]:px-20">
          {/* orange background */}
          <div class="flex flex-col gap-12 bg-gradient-to-b from-[#FDB235] to-[#F7C95F] p-24 rounded-4xl min-[769px]:p-20">
            ...
            <button className="cursor-pointer whitespace-nowrap shrink-0 gap-1 flex justify-center items-center rounded-full bg-[#4335DE] text-white font-bold py-[16px] pl-[20px] pr-[44px] max-w-44">
              About Us
              <MoveRight size={18} />
            </button>
          </div>
          ...
          <div class="flex flex-col text-center justify-center items-center gap-12 bg-white p-10 rounded-4xl min-[769px]:p-20 min-[769px]:items-start min-[769px]:text-start">
            <h2 className="text-[#02033B] font-bold text-2xl min-[769px]:text-3xl">
              Help Center
            </h2>
            <p className="text-[#02033B]">
            ...
            <button className="cursor-pointer border-2 whitespace-nowrap shrink-0 gap-1 flex justify-center items-center rounded-full text-[#02033B] font-bold py-[10px] px-[16px] max-w-44">
              Visit help center
            </button>
          </div>
        </section>
        ...
        <section className="bg-gradient-to-b from-[#2925CC] to-[#4B48E5] py-14 flex flex-col items-center text-center justify-center gap-7">
          ...
          <div className="flex flex-col gap-4 min-[769px]:flex-row gap-6">
            ...
            <button className="cursor-pointer whitespace-nowrap shrink-0 border-2 border-white text-white rounded-full font-bold py-2 px-6">
